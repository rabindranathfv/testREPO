...
@Component({
  selector: 'app-plants-per-devices',
  templateUrl: './plants-per-devices.component.html',
  styleUrls: ['./plants-per-devices.component.scss']
})
export class PlantsPerDevicesComponent implements OnInit {
  ...
  constructor( private _devicesService: DevicesService,
      ...
      this.datasCardBody = [
        ...
        { key: 'commune', type: 'string', label: 'Comuna' },
        { key: 'user_id', type: 'number', label: 'Usuario Associo' },
  ...
  public getCustomersByDevices() {
    this._devicesService.getDeviceByResourceId(this.resource, this.id, 'plants')
        .subscribe( (resp) => {
          console.log(resp);

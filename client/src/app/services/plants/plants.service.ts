...
export class PlantsService {
  ...
  */
   ...
   * getPlants
   */
  public getPlants( resource: string ): Observable<any> {
  ...
  /**
   * getPlantsByResourceId
   */
  public getPlantsByResourceId( resourceBase: string, id: number, resourceRelated: string): Observable<any> {
